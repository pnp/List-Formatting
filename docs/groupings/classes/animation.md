# Samples by Class: Animation

The `ms-motion-*` and `ms-*` classes apply various **transitions** and **timings** to apply to elements as they appear/disappear.
...
## ms-slideUpOut20
[:fontawesome-solid-lightbulb:](../../contributing/index.md){.ideaLink title="Contribution Opportunity!"}
<img src="https://pnptelemetry.azurewebsites.net/list-formatting/docs/groupings/animation" />
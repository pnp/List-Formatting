...
write-host "All steps are done. Please use the URL below to open the [ Budget Tracker ] page:" -Foreground "Green"
write-host $targetSiteUrl'/SitePages/budget-tracker.aspx' -Foreground "Yellow"
write-host `r
